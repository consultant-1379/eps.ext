...
public class AvroDataCollector implements DataCollector {

    private EPSMessageListener<GenericRecord> listener;

    private Subscriber<String, GenericRecord> createSubscriber;
    /* (non-Javadoc)
    ...
    public EPSMessageListener<GenericRecord> getListener() {
        return listener;
    }
