 ...
 * May 7, 2016
 */
public class GenericInputAdapterTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		properties.put("eps.format.data" ,"string");
	...
	public void testDoInit() {
		...
		inputA.init(new SubscriberTestHandler());
		assertNotNull(inputA.getDataCollector());
		assertTrue(inputA.getDataCollector() instanceof StringDataCollector);
	}
	
	
	
	/**
	 * Test method for {@link com.ericsson.component.aia.services.exteps.ioadapter.input.GenericInputAdapter#understandsURI(java.lang.String)}.
	 */
	@Test
 ...
 * @author eachsaj
 */
  final class SubscriberTestHandler implements EventHandlerContext {
	@Override
