...
public class StringDataCollector implements DataCollector {

    private EPSMessageListener<String> listener;

    private Subscriber<String, String> createSubscriber;
    /* (non-Javadoc)
    ...
    @Override
    public void stop() {
        checkState(listener != null, "listener is no active");
        listener.stop();
    }
    ...
    public EPSMessageListener<String> getListener() {
        return listener;
    }
    ...
    public boolean identify(String arg0) {
        return arg0.equalsIgnoreCase(IO_CONSTANTS.FORMAT_STRING);
    }
