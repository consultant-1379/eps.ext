...
public class StringDataProducer implements DataProducer {
    ...
    private Publisher<String, String> createProducer;
    ...
    private void connectPublisher(MessageServiceTypes uri, Properties props) {
        createProducer = ServiceFactory.<String, String>createPublisher(uri, props);
    ...
    @Override
    public  Publisher<String, String> getProducer() {
